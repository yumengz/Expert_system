...
directory_path = "/Users/wenqings/Desktop/Expert_system/open-webui"  # Change this to your target path
print_directory_structure(directory_path, level=5, omit=True)
