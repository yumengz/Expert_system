...
directory_path = "/Users/yumengzhou/Documents/GitHub/Expert_system/open-webui"  # Change this to your target path
print_directory_structure(directory_path, level=1, omit=True)
